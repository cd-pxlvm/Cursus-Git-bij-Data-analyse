...
De tabel met werkwijze project (wie wat waar) maken jullie in een .md bestand. Hirevoor moet je zelf op zoek hoe je een tabel maakt in MarkDown. De issues kan je gebruiken voor de planning en onderlingen afspraken. De visio bestanden komen ook in deze repo. Bij deze laatste is in GitHub geen versiebeheer mogelijk.  
